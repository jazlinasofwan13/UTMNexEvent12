    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonResetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty()) {
                    Toast.makeText(AdminForgotPasswordActivity.this, "Please enter your admin email", Toast.LENGTH_SHORT).show();
                    return;
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(AdminForgotPasswordActivity.this, "Admin reset email sent to " + email, Toast.LENGTH_LONG).show();
                                    finish();
                                } else {
                                    Toast.makeText(AdminForgotPasswordActivity.this, "Error: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
