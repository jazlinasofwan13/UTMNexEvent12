...
public class AdminEventParticipantsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_event_participants);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.admin_event_participants_main), (v, insets) -> {
                ...
                .addOnSuccessListener(aVoid -> {
                    db.collection("events").document(eventId)
                            ...
                            .addOnSuccessListener(v -> {
                                ...
                                Toast.makeText(this, "Participant removed by Admin", Toast.LENGTH_SHORT).show();
                                updateUI();
                            });
                })
